...
func (wc *WCliente) Consultar(w http.ResponseWriter, r *http.Request) {
	Cabecera(w, r)
	var M Respuesta
	var cliente interface{}
	url := sys.HTTPAPISYBASE + "cliente/consultar"
...
func (wc *WCliente) Pagos(w http.ResponseWriter, r *http.Request) {
	Cabecera(w, r)
	var M Respuesta
	var interfaz interface{}
	url := sys.HTTPAPISYBASE + "pago/lstpagoscliente"
